const langArr = {
    ...
    //intro
    "title-name": {
        "pl": "Vladlena Tsenzeria | web-developer",
        "ua": "Владлена Цензеря | web-developer",

    },
    "intro-title": {
        "pl": "Vladlena Tsenzeria",
        "ua": "Владлена Цензеря",
    },
    "intro-description": {
    ...
    //study
    "study-title": {
        "pl": "Сiągle się uczę nowego",
        "ua": "весь час навчаюсь новому",
    },
    "study-text": {
        "pl": "W 2017 roku ukończyłam uniwersytet, z zawodu jestem Analitykiem systemów komputerowych. Na studiach poznałam się z tworzeniem stron internetowych i od tego czasu ciągle pogłębiam swoją wiedzę w tej dziedzinie.",
        "ua": "В 2017 році закінчила університет за спеціальністю Аналітик комп’ютерних систем, маю ступінь магістра. В університеті познайомилась зі створенням вебсайтів і з того часу продовжую доповнювати свої знання в цій сфері.",
    },
    "course-1": {
        "pl": "• kurs Frontend developer w szkole Loftschool",
        "ua": "• курс в школі Loftschool, напрямок — Frontend розробка",
    },
    "course-2": {
        "pl": "• kurs Javascript na Udemy",
        "ua": "• курс з Javascript на Udemy",
    },
    "course-3": {
        "pl": "• kurs Web-design w szkole Genius Space",
    ...
    "features-text": {
        ...
        "ua": "Я з радістю зроблю для тебе сайт <span class='text-bold'>від самого початку і до завантаження на хостинг.</span> Спроектую унікальний дизайн-макет, який буде продавати. Напишу код для його реалізації. Налаштую пошук твого сайту в інтернеті. Завантажу сайт на хостинг.",
    },
    "features-text-2": {
    ...
    "builder-title": {
        ...
        "ua": "Ні! Шаблонним конструкторам",
    },
    "builder-description": {
        "pl": "Dużo projektantów stron internetowych nie zajmują się programowaniem, a tylko korzystają ze specjalnych kreatorów do tworzenia stron. Ale takie <span class='text-bold'> kreatory mają sporo wad. </span> Na przykład one mają ograniczony wybór szablonów, strony wykonane w takich kreatorach będą podobne. Funkcjonalność twojej witryny będzie zależała od możliwości takiego konstruktora. Czyli możliwe jest podłączenie tylko tych modułów, które posiada taki kreator.",
        "ua": "Більшість веб-розробників не займаються программуванням, а використовують конструктори сайтів при розробці. Але такі <span class='text-bold'>конструктори мають багато мінусів.</span> Наприклад, у них обмежений набір однотипних шаблонів. Сайти, зроблені в таких конструкторах, будуть подібними. Функціонал вашого сайту залежитиме від можливостей конструктора. Тобто, є можливість підключити тільки ті модулі, які пропонує конструктор.",
    },
